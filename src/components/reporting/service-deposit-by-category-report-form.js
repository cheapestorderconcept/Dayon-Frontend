...
import { getServiceDepositByCategoryReports } from "src/statesManagement/store/actions/reportingActions/service-report-action ";

export const ServiceDepositByCategoryReportForm = (props) => {
  ...
  return (
    <Box {...props}>
      ...
      >
        ...
        <Box sx={{ m: 1 }}>
          ...
          <Button startIcon={<DownloadIcon fontSize="small" />} sx={{ mr: 1 }}>
            Service Deposit By Category Report
          </Button>
      ...
      <Box sx={{ mt: 3 }}>
        <Card>
          <CardHeader title=" Service Deposit By Category Report" />
          <Divider />
          <CardContent>
            <Box sx={{ maxWidth: 800 }}>
