...
import ProductSalesTable from "src/components/product/product-sales-table";
              ...
              >
                ...
                >
                  ...
                  {cart.cartItems.reduce(
                    (a, c) => a + Number(c.product_price) * Number(c.quantity),
                    0
                  )}
                  )
                </Typography>
                ...
                {cart.cartItems.map((item) => (
                  ...
                  >
                    ...
                    <Grid item sx={4}>
                      <Typography variant="subtitle1"> ₦{item.product_price}</Typography>
                    </Grid>
