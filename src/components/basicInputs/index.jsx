...
export const SearchableSelect = ({ name, title, options, id, i, useId, fromCustomer, ...other }) => {
 
  const [value, setValue] = useState(fromCustomer ? options[0]: "");
  const [inputValue, setInputValue] = useState("");
  const { setFieldValue } = useFormikContext();
  fromCustomer && useEffect(() => {
